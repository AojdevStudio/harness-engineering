...
The active Symphony implementation line is `main` after the v0.2 release cutover merges. The historical `symphony-base` branch was the staging line for this cutover and should not be used for new work after merge.

The pre-release dirty checkout was audited on 2026-05-13 and should be treated as retired source material. Do not resume development from that checkout.
...
The dirty checkout source edits were older versions of work already merged into the v0.2 release line:
